...
def profile_update(request):
    ...
    if request.method == 'POST':
        ...
        if profile.is_valid():
            ...
            messages.success(request, f'Dear {new}, your profile has been updated')
...
def payment(request):
    if request.method == 'POST':
        ...
        api_key = 'sk_test_d1bacdbcdd5ba002e13e4876d5f2421b8840fefd' #secret key from paystack
        curl = 'https://api.paystack.co/transaction/initialize' #paystack call url
        cburl = 'http://13.51.156.56/callback' #callback or thank you page 
        ...
        #collect date to send to paystack via call url
